...
ARTIFACT = Path("/opt/cursor/artifacts/taxi_and_fly_fysiki_foni.mp4")

sys.path.insert(0, str(ROOT))
from build_video import duration, ff, make_audio, mix, xfade_concat  # noqa: E402

LINES = [
    "Από όπου κι αν βρίσκεσαι, έρχεσαι Αθήνα.",
    ...
    "Taxi and Fly. Για μετακινήσεις από και προς το αεροδρόμιο, με επαγγελματίες οδηγούς ταξί.",
]
